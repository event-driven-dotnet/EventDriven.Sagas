...
public class CustomerCommandHandler :
    ...
    ICommandHandler<ReserveCredit>,
    ICommandHandler<ReleaseCredit>
{
    ...
    public async Task<CommandResult> Handle(ReserveCredit command)
    {
    ...
    public async Task<CommandResult> Handle(ReleaseCredit command)
    {
    ...
    private async Task<CommandResult> PublishCreditReservedResponse(Customer customer, decimal creditRequested, bool success)
    {
    ...
    private async Task<CommandResult> PublishCreditReleasedResponse(Customer customer, decimal creditRequested, bool success)
    {
        // Publish response to event bus
